# ============================
# Ouroboros — Local launcher (macOS / Linux)
# ============================
# Drop-in replacement for colab_launcher.py without Google Colab dependencies.
...
# ----------------------------
# 1) Secrets + runtime config (from env vars / .env)
# ----------------------------
...
# macOS requires spawn for multiprocessing
...
# ----------------------------
# 2) Local data directory (replaces Google Drive)
# ----------------------------
DRIVE_ROOT = pathlib.Path(
    os.environ.get("OUROBOROS_DATA_DIR", pathlib.Path(__file__).parent / "local_data")
).resolve()
